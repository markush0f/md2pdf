  ...
  return (
    <div className="min-h-screen bg-[#F5F0E8]">
      <div className="grid grid-cols-[1fr_4px_1fr] min-h-screen">
        <div className="bg-[#FDFBF7] p-12 flex flex-col">
          <header className="flex items-center justify-between mb-16">
            ...
            {file && (
              <button
                ...
                className="group flex items-center gap-2 px-4 py-2 border-2 border-[#1A1A1A] hover:bg-[#1A1A1A] transition-all"
              >
                <svg
                  className="w-4 h-4 text-[#1A1A1A] group-hover:text-white transition-colors"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
                ...
                <span className="font-mono text-sm text-[#1A1A1A] group-hover:text-white transition-colors">
                  Clear
                </span>
              </button>
            )}
          ...
          {!file ? (
            <div className="flex-1 flex flex-col items-center justify-center">
              <div
                className={`relative w-full max-w-lg border-[3px] p-20 transition-all duration-300 cursor-pointer ${
                  isDragging
                    ...
                    : "border-[#1A1A1A] bg-white hover:shadow-[8px_8px_0_0_#1A1A1A]"
                }`}
                onDrop={handleDrop}
              ...
              >
                ...
                <div className="flex flex-col items-center text-center">
                  ...
                  >
                    <svg
                      className={`w-12 h-12 transition-colors duration-300 ${
                        isDragging ? "text-[#E85D04]" : "text-[#1A1A1A]"
                      }`}
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                  ...
                  <h2 className="text-3xl font-bold mb-3 text-[#1A1A1A] tracking-tight">
            ...
            <div className="flex-1 flex flex-col">
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  <span className="font-mono text-base text-[#1A1A1A] font-medium">
                    {file.name}
                  </span>
              ...
              <div className="flex-1 border-[3px] border-[#1A1A1A] bg-white p-8 overflow-auto shadow-[6px_6px_0_0_#1A1A1A]">
          ...
          <footer className="mt-auto pt-8 flex items-center justify-between border-t border-stone-200">
        ...
        <div className="bg-white p-12 flex flex-col">
          <header className="flex items-center justify-between mb-16">
            ...
            <span className="px-3 py-1 bg-[#1A1A1A] text-white text-xs font-mono">
              MOCK
            </span>
          </header>
            ...
            {!file ? (
              <div className="h-full flex items-center justify-center">
                <div className="text-center">
                  <div className="w-72 h-96 border-[3px] border-dashed border-stone-300 flex items-center justify-center mb-6 bg-stone-50 relative overflow-hidden">
                    <div className="absolute inset-0 opacity-50">
                      <div className="absolute top-4 left-4 right-4 h-px bg-stone-200" />
                      <div className="absolute top-8 left-6 right-6 h-px bg-stone-200" />
                      <div className="absolute top-12 left-8 right-8 h-px bg-stone-200" />
                      <div className="absolute top-16 left-10 right-10 h-px bg-stone-200" />
                    </div>
                    <p className="text-stone-400 font-mono text-sm relative z-10">
              ...
              <div className="bg-white shadow-[16px_16px_0_0_#1A1A1A]">
                ...
                <div className="px-10 py-8">
                  ...
                  <blockquote className="bg-[#F5F0E8] p-6 mb-6 border-l-4 border-[#E85D04]">
  ...
  return \`Hello, \${name}!\`;
          ...
          {file && (
            <div className="mt-8 pt-8 border-t border-stone-200">
              <button className="group w-full flex items-center justify-center gap-3 px-8 py-4 bg-[#E85D04] text-white font-bold text-xl hover:bg-[#1A1A1A] transition-all duration-300 shadow-[4px_4px_0_0_#1A1A1A] hover:shadow-[6px_6px_0_0_#1A1A1A]">
                <svg
                  className="w-6 h-6"
                  fill="none"
                  stroke="currentColor"
